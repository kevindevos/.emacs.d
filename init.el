...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (meghanada origami hideshow-org ag helm-ag evil-surround color-theme-sanityinc-tomorrow telephone-line zone-nyan plan9-theme flycheck yasnippet git-gutter+ company neotree projectile magit general helm evil use-package))))
(custom-set-faces
