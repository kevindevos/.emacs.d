...
(eval-when-compile
  ...
  (use-package ag :ensure t :defer)
  (use-package android-mode :ensure t :defer)
  (use-package back-button :ensure t :defer)
  (use-package button-lock :ensure t :defer)
  (use-package ccls :ensure t :defer)
  (use-package cmake-ide :ensure t :defer)
  (use-package color-theme-sanityinc-tomorrow :ensure t :defer)
  (use-package company-box :ensure t :defer)
  (use-package company-lsp :ensure t :defer)
  (use-package cquery :ensure t :defer)
  (use-package dap-mode :ensure t :defer)
  (use-package bui :ensure t :defer)
  (use-package doom-modeline :ensure t :defer)
  (use-package all-the-icons :ensure t :defer)
  (use-package doom-themes :ensure t :defer)
  (use-package eglot :ensure t :defer)
  (use-package evil-collection :ensure t :defer)
  (use-package annalist :ensure t :defer)
  (use-package evil-ediff :ensure t :defer)
  (use-package evil-magit :ensure t :defer)
  (use-package evil-surround :ensure t :defer)
  (use-package fill-column-indicator :ensure t :defer)
  (use-package flucui-themes :ensure t :defer)
  (use-package flycheck-gradle :ensure t :defer)
  (use-package flycheck-pos-tip :ensure t :defer)
  (use-package flymake-gradle :ensure t :defer)
  (use-package general :ensure t :defer)
  (use-package ggtags :ensure t :defer)
  (use-package ghub :ensure t :defer)
  (use-package git-gutter :ensure t :defer)
  (use-package github-theme :ensure t :defer)
  (use-package google-c-style :ensure t :defer)
  (use-package google-this :ensure t :defer)
  (use-package gradle-mode :ensure t :defer)
  (use-package graphql :ensure t :defer)
  (use-package groovy-mode :ensure t :defer)
  (use-package helm-ag :ensure t :defer)
  (use-package helm-gtags :ensure t :defer)
  (use-package helm-lsp :ensure t :defer)
  (use-package helm-projectile :ensure t :defer)
  (use-package helm-swoop :ensure t :defer)
  (use-package helm-xref :ensure t :defer)
  (use-package helm :ensure t :defer)
  (use-package helm-core :ensure t :defer)
  (use-package hideshow-org :ensure t :defer)
  (use-package iedit :ensure t :defer)
  (use-package levenshtein :ensure t :defer)
  (use-package lsp-java :ensure t :defer)
  (use-package lsp-python-ms :ensure t :defer)
  (use-package lsp-treemacs :ensure t :defer)
  (use-package lsp-ui :ensure t :defer)
  (use-package lsp-mode :ensure t :defer)
  (use-package dash-functional :ensure t :defer)
  (use-package magit-popup :ensure t :defer)
  (use-package markdown-mode :ensure t :defer)
  (use-package material-theme :ensure t :defer)
  (use-package meghanada :ensure t :defer)
  (use-package company :ensure t :defer)
  (use-package memoize :ensure t :defer)
  (use-package nav-flash :ensure t :defer)
  (use-package omnisharp :ensure t :defer)
  (use-package csharp-mode :ensure t :defer)
  (use-package auto-complete :ensure t :defer)
  (use-package flycheck :ensure t :defer)
  (use-package origami :ensure t :defer)
  (use-package plan9-theme :ensure t :defer)
  (use-package popup :ensure t :defer)
  (use-package pos-tip :ensure t :defer)
  (use-package python-mode :ensure t :defer)
  (use-package rainbow-delimiters :ensure t :defer)
  (use-package rainbow-mode :ensure t :defer)
  (use-package request :ensure t :defer)
  (use-package rtags :ensure t :defer)
  (use-package shrink-path :ensure t :defer)
  (use-package shut-up :ensure t :defer)
  (use-package smartrep :ensure t :defer)
  (use-package spacemacs-theme :ensure t :defer)
  (use-package spinner :ensure t :defer)
  (use-package string-utils :ensure t :defer)
  (use-package swiper :ensure t :defer)
  (use-package ivy :ensure t :defer)
  (use-package telephone-line :ensure t :defer)
  (use-package tree-mode :ensure t :defer)
  (use-package treemacs-evil :ensure t :defer)
  (use-package evil :ensure t :defer)
  (use-package goto-chg :ensure t :defer)
  (use-package treemacs-icons-dired :ensure t :defer)
  (use-package treemacs-magit :ensure t :defer)
  (use-package magit :ensure t :defer)
  (use-package transient :ensure t :defer)
  (use-package git-commit :ensure t :defer)
  (use-package treemacs-projectile :ensure t :defer)
  (use-package treemacs :ensure t :defer)
  (use-package ht :ensure t :defer)
  (use-package hydra :ensure t :defer)
  (use-package lv :ensure t :defer)
  (use-package pfuture :ensure t :defer)
  (use-package ace-window :ensure t :defer)
  (use-package avy :ensure t :defer)
  (use-package f :ensure t :defer)
  (use-package s :ensure t :defer)
  (use-package dash :ensure t :defer)
  (use-package projectile :ensure t :defer)
  (use-package pkg-info :ensure t :defer)
  (use-package epl :ensure t :defer)
  (use-package treepy :ensure t :defer)
  (use-package twilight-bright-theme :ensure t :defer)
  (use-package ucs-utils :ensure t :defer)
  (use-package persistent-soft :ensure t :defer)
  (use-package list-utils :ensure t :defer)
  (use-package pcache :ensure t :defer)
  (use-package undo-tree :ensure t :defer)
  (use-package use-package :ensure t :defer)
  (use-package bind-key :ensure t :defer)
  (use-package wgrep :ensure t :defer)
  (use-package which-key :ensure t :defer)
  (use-package with-editor :ensure t :defer)
  (use-package async :ensure t :defer)
  (use-package yasnippet :ensure t :defer)
  (use-package zone-nyan :ensure t :defer)
  (use-package esxml :ensure t :defer)
  (use-package zoutline :ensure t :defer)
  (use-package doom-themes :ensure t :defer)
)
...
(use-package company
  ...
  (progn
    ...
    (setq company-backends '(company-bbdb company-semantic company-clang company-capf company-keywords
					  ...
					  company-oddmuse company-yasnippet))
    (global-company-mode)
    )
  )
...
(custom-set-variables
 ...
 '(flycheck-pos-tip-timeout 99999)
